...
fig, axs = plt.subplots(2, 6, figsize=(22, 8), sharex=True)
fig.suptitle("Métricas de Treinamento - Todos os 6 Folds", fontsize=16, fontweight='bold')
...
for fold_idx in range(6):
    ...
    test_loss = checkpoint["test_losses_epoch"]
    train_acc = checkpoint["train_accuracies_epoch"]
    test_acc = checkpoint["test_accuracies_epoch"]
    ...
    ax_loss.plot(epochs, test_loss, color='red', linestyle='--', label='Test')
