...
class SpaceTimeCNN(nn.Module):
    ...
    def __init__(self):
        ...
        # Entrada:
        #
        # (batch, frequency, time, row, column)
        #
        # (8, 65, 9, 21, 21)
...
def main():
    ...
    MODEL_DIR = OUTPUT_DIR / "space_time_models" / subject
    ...
    # Depois:
    #
    # (epoch, time, frequency, row, column) - space-frequency
    # (epoch, frequency, time, row, column) - space-time
    ...
    for fold in range(1, N_FOLDS + 1):
        ...
        torch.save(
            ...
            MODEL_DIR / f"space_time_fold_{fold}.pth"
        )
